...
export default function FighterDetailOverlay({
  fighter,
  sourceEl,
  onClose,
}: FighterDetailOverlayProps) {
        ...
        <div className={classes.details} ref={contentRef}>
          ...
          <Group className={classes.record} gap={0}>
            <Stack gap={0} align="center" px="lg" py="sm">
              <Text className={classes.recordNum} data-type="wins">
                {fighter.record.wins}
              </Text>
            ...
            <Stack gap={0} align="center" px="lg" py="sm">
              <Text className={classes.recordNum} data-type="losses">
            ...
            {fighter.record.draws > 0 && (
              <>
                <Divider orientation="vertical" />
                <Stack gap={0} align="center" px="lg" py="sm">
                  <Text className={classes.recordNum} data-type="draws">
